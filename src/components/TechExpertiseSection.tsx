...
const expertiseAreas = [
    {
        ...
        desc: "Customized professional training programmes designed to strengthen employee capabilities and organizational effectiveness. Staff development, management training, customized workshops and capacity-building programmes.",
        images: [
    ...
    },
    {
        ...
        desc: "Structured advisory support that helps organizations clarify priorities, strengthen decisions and plan for sustainable growth.",
        images: [
    ...
    },
    {
        ...
        desc: "Practical support for strengthening structures, processes, accountability and institutional effectiveness.",
        images: [
    ...
    },
    {
        ...
        desc: "Financial planning and forecasting support that improves resource allocation, accountability and performance tracking.",
        images: [
    ...
    },
    {
        ...
        desc: "Customized training programmes, workshops and staff development initiatives designed around organizational needs.",
        images: [
    ...
    },
    {
        ...
        desc: "Strategic procurement and supply support that promotes value, efficiency and dependable delivery.",
        images: [
...
function ExpertiseCard({ area }: { area: typeof expertiseAreas[0] }) {
    ...
    return (
        <div 
            className="group relative h-96 overflow-hidden rounded-2xl shadow-lg cursor-pointer transition-all duration-150 hover:scale-110 z-0 hover:z-20 hover:ring-1 hover:ring-khahusGold"
        ...
        >
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end text-white">
                <h3 className="text-2xl font-bold mb-2 text-khahusGold group-hover:text-white drop-shadow-sm transition-all duration-300 group-hover:-translate-y-2">
                    {area.title}
                </h3>
                <p className="text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0 text-white/80">
                    {area.desc}
                </p>
            </div>
        </div>
...
export default function TechExpertiseSection() {
    return (
        <section className="py-16 bg-khahusMist overflow-hidden" id="expertise">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-extrabold text-khahusNavy mb-4 transition-all duration-500 hover:tracking-tight">
                        Our Expertise
                    </h2>
                    <div className="w-24 h-1 mx-auto mb-4 animate-premium-line rounded-full"></div>
                    <p className="text-khahusSlate max-w-3xl mx-auto text-lg leading-relaxed">
                        We deliver practical, high-impact consulting and capacity-building support designed to strengthen organizations, improve performance, and drive sustainable growth.
                    </p>
                </div>
