    ...
    return (
        <section className="relative py-24 lg:py-32 flex items-center justify-center" id="operations">
            ...
            <div className="relative z-10 w-full max-w-4xl mx-auto px-4 flex justify-center py-6">
                <div className="bg-khahusRed px-8 py-8 md:px-12 md:py-10 rounded-2xl shadow-2xl text-center max-w-[600px] w-full transform hover:scale-110 transition-all duration-150 hover:ring-1 hover:ring-khahusGold/70">
                    ...
                    <p className="text-sm md:text-base text-white/95 mb-6 max-w-2xl mx-auto font-medium leading-normal">
                        Transform your organization with strategic consulting, professional training, and expert advisory services designed to drive sustainable performance and growth.
                    </p>
                    <Link
                        href="#contact"
                        className="inline-block px-8 py-3 bg-white text-khahusRed font-bold text-sm md:text-base rounded shadow-lg hover:shadow-xl hover:bg-khahusMist transition-all duration-300 animate-bounce"
                    >
